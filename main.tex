...
\usepackage[notes,backend=biber,useibid=false,url = false,isbn=false]{biblatex-chicago}
\usepackage{endnotes}
...
\title{Jerry Goldsmith’s Alien Score and the Representation of the American National Character}
% \author{Calum White}
 \date{}
...
This paper examines Ridley Scott’s \textit{Alien} soundtrack and its representation of an American identity shaped by Fredrick Turner’s “Frontier Thesis.” I argue the soundtrack comments upon the film’s political ideology and laments the apparent downfall of the traditional American patriarch, while advocating for regressive gender roles, and critiquing unrestrained capitalism.
...
Megan Mondi, for example, critised Turner’s claim that the frontier was ``an area of free land” by noting that this freedom was not extended to women.\autocite[][31]{mondi_connected_2006}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{Images/alien-approaching-bedroom.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{Images/alien-bedroom-waking.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{Images/alien-dallas-bluecollar.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{Images/alien-patting-jones.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{Images/alien-ending-profile.jpg}
